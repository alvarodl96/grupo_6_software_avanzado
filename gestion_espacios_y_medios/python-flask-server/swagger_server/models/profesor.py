...
class Profesor(Model):
    ...
    def __init__(self, dni: int=None, nombre: str=None, apellidos: str=None, asignatura: str=None):
        ...
        :type apellidos: str
        :param asignatura: The asignatura of this Profesor.
        :type asignatura: str
        """
        self.swagger_types = {
            'dni': int,
    ...
    def asignatura(self) -> str:
        """
        Gets the asignatura of this Profesor.

        :return: The asignatura of this Profesor.
        :rtype: str
        """
    ...
    def asignatura(self, asignatura: str):
        """
        Sets the asignatura of this Profesor.
